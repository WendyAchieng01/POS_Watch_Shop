...
<body> 
    ...
    <!-- Body section -->
    <div class = "body_sec1"> 
	   <h3 class = "body_sec1_header">Approved Orders</h3>
        <table class ="body_sec1_table">
         ...
         <tr>
            ...
            <th>
			<h2 class = "body_sec1_table_headers"><?php include("totalaporders.php");?>  Approved Orders</h2>
			</th>
...
$sql = "SELECT * FROM orders WHERE payment_status LIKE 'Approved'";
...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
		...
		echo "Order Date:<input type=text name='date' value='$date' class='formcell2'  readonly/>";
		echo "<br>";
