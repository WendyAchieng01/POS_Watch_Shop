...
<body> 
    ...
    <!-- Body section -->
    <div class = "body_sec1"> 
	   <h3 class = "body_sec1_header">Orders</h3>
        <table class ="body_sec1_table">
         <tr>
		 
            <th>
			<h2 class = "body_sec1_table_headers">Orders</h2>
			</th>
         </tr>
           ...
           <td>
			<div>
			 ...
			 <table class = "viewstaff_table" > 
              	 ...
              	 <tr>			
                     <td>				
                      <h2 class = "viewstaff_table_headers">Orders</h2>			
                     </td>								 
                 </tr>
                  ...
                  <tr>
				     <td>
                      <form action="adminorders.php" method="post" >
                        <input class = "register_staff_button" type = "submit" name= "new_orders" value = "<?php include("totalneworders.php");?> New Orders"/>
                      </form>					   
					 </td>
                 </tr>
                 <tr>
				     <td>
                      <form action="adminorders.php" method="post" >
                        <input class = "register_staff_button" type = "submit" name= "approved_orders" value = "<?php include("totalaporders.php");?> Approved Orders"/>
                      </form>					   
					 </td>
                 </tr>	
                 <tr>
				     <td>
                      <form action="adminorders.php" method="post" >
                        <input class = "register_staff_button" type = "submit" name= "declined_orders" value = "<?php include("totaldeorders.php");?> Declined Orders"/>
                      </form>					   
					 </td>
                 </tr>				 
                  <tr>
				     <td>
                      <form action="adminorders.php" method="post" >
                        <input class = "register_staff_button" type = "submit" name= "view_all_orders" value = "View All Orders"/>
                      </form>					   
					 </td>
					 <td> 			
                      <h3 class = "viewstaff_table_headers2">Total Orders: <?php include "totalorders.php";?> </h3>			
                     </td>
                 </tr>
				 <td>
                      <form action="adminorders.php" method="post" >
                        <input class = "search" type = "search" name= "search_order" placeholder = "Search Order" required = "required" />
				 ...
				 <tr>
				     <td>
	 <?php 
        if(array_key_exists('view_all_orders', $_POST)) { 
            button2(); 
        }
		else if(array_key_exists('new_orders', $_POST)) { 
            button1(); 
        }
        else if(array_key_exists('search_order', $_POST)) { 
            button4(); 
        }
        else if(array_key_exists('approved_orders', $_POST)) { 
            button6(); 
        }
        else if(array_key_exists('declined_orders', $_POST)) { 
            button8(); 
        }
        function button1() { 
        ...
        function button6() { 
		 ...
		 include "aporders.php";
        }
        function button8() { 
		
		 include "deorders.php";
        }		
    ?> 	
