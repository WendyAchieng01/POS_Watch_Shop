...
<body> 
    ...
    <!-- Body section -->
    <div class = "body_sec1"> 
	   <h3 class = "body_sec1_header">Contact</h3>
        <table class ="body_sec1_table">
         <tr>
		 
            <th>
			<h2 class = "body_sec1_table_headers">Contact Form</h2>
			</th>
			   ...
			   <form action = "contact2.php" method = "post">
                 <tr>
                     ...
                     <td>				
					  ...
					  <?php
					  include "contacttext.php";
					  ?>
					  </p>			
                     </td>
			     </tr>		 
              	 <tr>			
                     <td class = "contact_table_headers">				
                       First Name			
                     </td>			
                     <td>				
                       <input class = "contact_table_input" type= "text" name= "first_name" required = "required" placeholder = "First Name"/>			
                     </td>
				 </tr>
                 <tr>				 
                     <td class = "contact_table_headers">				
                     ...
                     <td>				
                       <input class = "contact_table_input" type= "text" name= "second_name" required = "required" placeholder = "Second Name"/>			
                     </td>					 
                 </tr>
				 <tr>				 
                     <td class = "contact_table_headers">				
                     ...
                     <td>				
                       <input class = "contact_table_input" type= "text" name= "last_name" required = "required" placeholder = "Last Name"/>			
                     </td>					 
                 </tr>
                 <tr>
                     <td class = "contact_table_headers">				
                     ...
                     <td>				
                       <input class = "contact_table_input" type="date" name="date_today" required = "required"/>			
                     </td>					 
                 </tr>
                 <tr>			
                     <td class = "contact_table_headers">				
                     ...
                     <td>				
                       <input class = "contact_table_input" type= "email" name= "email" required = "required" placeholder = "Email"/>			
                     </td>		
                 </tr>
				 <tr>			
                     <td class = "contact_table_headers">				
                     ...
                     <td>				
                      <input class = "contact_table_input" type= "tel" name= "phone_number" required = "required" placeholder = "Phone Number"/>			
                     </td>
				 </tr>	
                 <tr>				 
                     <td class = "contact_table_headers">				
                     ...
                     <td>					 
   <select class = "contact_table_input" name="country_code" required = "required">
	...
	<optgroup label="Other countries">
		...
		<option data-countryCode="ZW" value="263">Zimbabwe (+263)</option>
                 ...
                 <tr>
                     ...
                     <td>				
                       <input class = "contact_table_message_input" type= "text" name= "message" required = "required" placeholder = "Write to us..."/>			
                     </td>		
                 </tr>
                 <tr>			
                     <td class = "contact_table_headers">				
                     ...
                     <td>				
                       <input class = "signup_table_input" type= "text" name= "request_status" value="Pending" hidden/>			
                     </td>		
                 </tr>				 
                 <tr>
                     <td>				
                      <p class = "instruction" >Write to Modern Watch Shop </p>			
                     </td>				 
                     <td>
                      <center>					 
                       <input class = "send_button" type = "submit" name = "submit" value = "Send" />			
                      </center>
					 </td>
                     <td>					 
					  <center>					 
