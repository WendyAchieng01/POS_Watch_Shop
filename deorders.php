...
<body> 
    ...
    <!-- Body section -->
    <div class = "body_sec1"> 
	   <h3 class = "body_sec1_header">Declined Orders</h3>
        <table class ="body_sec1_table">
         ...
         <tr>
            ...
            <th>
			<h2 class = "body_sec1_table_headers"><?php include("totaldeorders.php");?>  Declined Orders</h2>
			</th>
...
$sql = "SELECT * FROM orders WHERE payment_status LIKE 'Declined'";
