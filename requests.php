...
<body> 
    ...
    <!-- Body section -->
    <div class = "body_sec1"> 
	   <h3 class = "body_sec1_header">Requests</h3>
        <table class ="body_sec1_table">
         <tr>
		 
            <th>
			<h2 class = "body_sec1_table_headers">Requests</h2>
			</th>
           ...
           <td>
			<div>
			 ...
			 <table class = "adminhome_table" > 
              	 ...
              	 <tr>			
                     <td>				
                      <h2 class = "adminhome_table_headers">Requests</h2>			
                     </td>								 
                 </tr>
				 <tr>
				     <td>
                      <form action="requests.php" method="post" >
                        <input class = "register_staff_button" type = "submit" name= "new_requests" value = "<?php include("totalrequests.php");?> New Requests"/>
                      </form>					   
					 </td>
                 </tr>
                  <tr>
				     <td>
                      <form action="requests.php" method="post" >
                        <input class = "register_staff_button" type = "submit" name= "approved_requests" value = "<?php include("totalaprequests.php");?> Approved Requests"/>
                      </form>					   
					 </td>
                 </tr>				 
                  <tr>
				     <td>
                      <form action="requests.php" method="post" >
                        <input class = "register_staff_button" type = "submit" name= "declined_requests" value = "<?php include("totalderequests.php");?> Declined Requests"/>
                      </form>					   
					 </td>
                 </tr>
				 <tr>
				     <td>
                      <form action="requests.php" method="post" >
                        <input class = "register_staff_button" type = "submit" name= "all_requests" value = "<?php include("totalallrequests.php");?> All Requests"/>
                      </form>					   
					 </td>
                 </tr>
				 <tr>
				     <td>
                      <form action="requests.php" method="post" >
                        <input class = "search" type = "search" name= "search_request" placeholder = "Search Request" required = "required" />
				 ...
				 <tr>
				     <td>
	 <?php
        if(array_key_exists('new_requests', $_POST)) { 
            button1(); 
        } 
        else if(array_key_exists('approved_requests', $_POST)) { 
            button2(); 
        }
        else if(array_key_exists('search_request', $_POST)) { 
            button4(); 
        }
        else if(array_key_exists('declined_requests', $_POST)) { 
            button6(); 
        }
        else if(array_key_exists('all_requests', $_POST)) { 
            button8(); 
        }		
        function button1() { 
          include "newrequests.php"; 
        } 
        function button2() { 
		
		 include "approvedrequests.php";
        }  
		function button4() { 
		
		 include "searchrequest.php";
        }
        function button6() { 
		
		 include "declinedrequests.php";
        }
        function button8() { 
