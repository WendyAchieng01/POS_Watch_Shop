...
$sql = "SELECT * FROM watches WHERE  brand LIKE '%".$search_watch1."%' OR color LIKE '%".$search_watch1."%' OR strap LIKE '%".$search_watch1."%' OR category LIKE '%".$search_watch1."%' OR price = '".$search_watch1."'ORDER BY brand";
