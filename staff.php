...
<body> 
    ...
    <!-- Body section -->
    <div class = "body_sec1"> 
	   <h3 class = "body_sec1_header">Staff Login</h3>
        <table class ="body_sec1_table">
         <tr>
		 
            <th>
			<h2 class = "body_sec1_table_headers">Staff Login Form</h2>
			</th>
			   ...
			   <form action="staff2.php" method="post">
                   <tr>
                     ...
                     <td>				
					  ...
					  <?php
					  include "stafferror.php";
					  ?>
					  </p>			
                     </td>
			     </tr>				   
              	 <tr>			
                     <td class = "staff_login_table_headers">				
                       Username			
                     </td>			
                     <td>				
                       <input class = "staff_login_table_input" type= "text" name= "username" required = "required" placeholder = "Username">			
                     </td>					 
                 </tr>
                 <tr>
                     <td class = "staff_login_table_headers">				
                     ...
                     <td>				
                       <input class = "staff_login_table_input" type= "password" name= "password" id = "myInput" required = "required" placeholder = "Password">			
                    </td>					
                 </tr>
                 <tr>
                     <td>				
