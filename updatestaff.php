...
$sql = "UPDATE staff SET first_name= '".$first_name1."',second_name= '".$second_name1."',last_name= '".$last_name1."',password= '".$pass1."',username= '".$user1."',date_today= '".$date_today1."',position_title= '".$position_title1."',email= '".$email1."',date_of_birth= '".$date_of_birth1."',id_card_number= '".$id_card_number1."',phone_number= '".$phone_number1."',country_code= '".$country_code1."',gender= '".$gender1."',county= '".$county1."',country= '".$country1."',address= '".$address1."' WHERE id= '".$userid1."'";
