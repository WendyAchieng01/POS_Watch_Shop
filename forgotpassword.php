...
<body> 
    ...
    <!-- Body section -->
    <div class = "body_sec1"> 
	   <h3 class = "body_sec1_header">Forgot Password</h3>
        <table class ="body_sec1_table">
         <tr>
		 
            <th>
			<h2 class = "body_sec1_table_headers">Forgot Password Form</h2>
			</th>
         ...
         <tr>
           <td>
			<div>
			 <center>
			 <table class = "forgot_password_table" > 
			   <form action="forgotpassword2.php" method="post">	
			       <tr>
                     <td>				
					  ...
					  <?php
					  include "forgotpassworderror.php";
					  ?>
					  </p>			
                     </td>
              	 ...
              	 <tr>			
                     <td class = "forgot_password_table_headers">				
                       Username			
                     </td>			
                     <td>				
                       <input class = "forgot_password_table_input" type= "text" name= "username" required = "required" placeholder = "Username"/>			
                     </td>					 
                 </tr>
                  <tr>			
                     <td class = "forgot_password_table_headers">				
                     ...
                     <td>				
                       <input class = "forgot_password_table_input" type= "email" name= "email" required = "required" placeholder = "Email"/>			
                     </td>		
                 </tr>
				 <tr>			
                     ...
                     <td>				
                       <input class = "signup_table_input" type= "text" name= "request" value="Password" hidden/>			
                     </td>		
                 </tr>
				 <tr>			
                     <td class = "contact_table_headers">				
                 ...
                 <tr>
                     <td>				
                      <p class = "instruction" >Send Email to Modern Watch Shop </p>			
                     </td>				 
                     <td>
                      <center>					 
