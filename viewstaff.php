...
<body> 
    ...
    <!-- Body section -->
    <div class = "body_sec1"> 
	   <h3 class = "body_sec1_header">View Staff</h3>
        <table class ="body_sec1_table">
         <tr>
		 
            <th>
			<h2 class = "body_sec1_table_headers">View Staff</h2>
			</th>
           ...
           <td>
			<div>
			 ...
			 <table class = "viewstaff_table" > 
              	 ...
              	 <tr>			
                     <td>				
                      <h2 class = "viewstaff_table_headers">Staff Members</h2>			
                     </td>								 
                 </tr>
                  ...
                  <tr>
				     <td>
                      <form action="viewstaff.php" method="post" >
                        <input class = "register_staff_button" type = "submit" name= "view_all_staff" value = "View All Staff"/>
                      </form>					   
					 </td>
					 <td> 			
                      <h3 class = "viewstaff_table_headers2">Total Staff Members: <?php include "totalstaff.php"; ?> </h3>			
                     </td>
                 </tr>
				 <td>
                      <form action="viewstaff.php" method="post" >
                        <input class = "search" type = "search" name= "search_staff" placeholder = "Search Staff" required = "required" />
				 ...
				 <tr>
				     <td>
	 <?php
        if(array_key_exists('view_all_staff', $_POST)) { 
            button2(); 
        }
        else if(array_key_exists('search_staff', $_POST)) { 
            button4(); 
        }		 
        function button2() { 
		
		 include "viewstaff2.php";
        } 
		function button4() { 
