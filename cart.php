...
<body> 
    ...
    <!-- Body section -->
    <div class = "body_sec1"> 
	   <h3 class = "body_sec1_header">Shopping Cart</h3>
        <table class ="body_sec1_table">
         <tr>
		 
            <th>
			<h2 class = "body_sec1_table_headers">Shopping Cart</h2>
			</th>
...
function goBack() {
  window.history.back();
				 ...
				 <tr>
                    <td>
			         <form>
                        <a href = "clearcart.php"><input class = "cart_btn" type = "button" value = "Clear Cart"/></a>
                     </form>
			      </td>								
                 </tr>
                 <tr>
