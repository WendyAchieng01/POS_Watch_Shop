...
<body> 
    ...
    <!-- Body section -->
    <div class = "body_sec1"> 
	   <h3 class = "body_sec1_header">Search User</h3>
...
$search_staff=$_POST['search_user'];
$search_staff1=mysqli_real_escape_string($conn,$search_staff);
	
$sql = "SELECT * FROM users WHERE  username LIKE '%".$search_staff1."%' OR first_name LIKE '%".$search_staff1."%' OR second_name LIKE '%".$search_staff1."%' OR last_name LIKE '%".$search_staff1."%' ";
