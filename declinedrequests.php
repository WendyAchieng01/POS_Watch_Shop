...
<body> 
    ...
    <!-- Body section -->
    <div class = "body_sec1"> 
	   <h3 class = "body_sec1_header">Declined Requests</h3>
        <table class ="body_sec1_table">
         ...
         <tr>
            ...
            <th>
			<h2 class = "body_sec1_table_headers"><?php include("totalderequests.php");?> Declined Requestss</h2>
			</th>
...
$sql = "SELECT * FROM requests WHERE request_status LIKE 'Declined'";
