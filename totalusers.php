...
<body> 
    ...
    <!-- Body section -->
    <div class = "body_sec1"> 
	   <h3 class = "body_sec1_header">Users</h3>
        <table class ="body_sec1_table">
         <tr>
		 
            <th>
			<h2 class = "body_sec1_table_headers">View Users</h2>
			</th>
           ...
           <td>
			<div>
			 ...
			 <table class = "viewstaff_table" > 
              	 ...
              	 <tr>			
                     <td>				
                      <h2 class = "viewstaff_table_headers">System Users</h2>			
                     </td>								 
                 </tr>
                 ...
                 <tr>
				     <td>
                      <form action="totalusers.php" method="post" >
                        <input class = "register_staff_button" type = "submit" name= "reg_new_user" value = "Register New User"/>
                      </form>					   
					 </td>
                 </tr>				 
                  <tr>
				     <td>
                      <form action="totalusers.php" method="post" >
                        <input class = "register_staff_button" type = "submit" name= "view_all_users" value = "View All Users"/>
                      </form>					   
					 </td>
					 <td> 			
                      <h3 class = "viewstaff_table_headers2">Total Users: <?php include "totalusers2.php"; ?> </h3>			
                     </td>
                 </tr>
				 <td>
                      <form action="totalusers.php" method="post" >
                        <input class = "search" type = "search" name= "search_user" placeholder = "Search User" required = "required" />
				 ...
				 <tr>
				     <td>
	 <?php
        if(array_key_exists('reg_new_user', $_POST)) { 
            button1(); 
        } 
        else if(array_key_exists('view_all_users', $_POST)) { 
            button2(); 
        }
        else if(array_key_exists('search_user', $_POST)) { 
            button4(); 
        }		
        function button1() { 
